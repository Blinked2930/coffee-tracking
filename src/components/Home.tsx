...
export default function Home({ user, onKafeLogged }: HomeProps) {
  ...
  return (
    // STRICT h-[100dvh] guarantees no scrollable whitespace, but native mobile browsers will still elastic-bounce it.
    <div className="flex flex-col w-full h-[100dvh] bg-gray-50/30">
      ...
      <div className="flex-1 w-full max-w-sm mx-auto flex flex-col items-center justify-center px-5">
        ...
        {/* Main Cutesy Button - Size increased for better tactility */}
      ...
      {/* HARDCODED NAV BAR COMPENSATOR: 90px */}
      <div className="w-full shrink-0 h-[90px]" />
