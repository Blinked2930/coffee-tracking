    ...
    <div className="fixed inset-0 w-full bg-gray-50/30 overflow-hidden flex flex-col pb-[125px]">
      ...
      <div className={clsx(
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-3 bg-gray-50 p-4 rounded-2xl focus-within:ring-2 focus-within:ring-amber-500/20 focus-within:bg-white transition-colors border border-transparent focus-within:border-amber-200">
          ...
          <div className="flex gap-4">
            ...
            <div className="flex-[1.2] flex items-start gap-3 bg-gray-50 p-4 rounded-2xl focus-within:ring-2 focus-within:ring-amber-500/20 focus-within:bg-white transition-colors border border-transparent focus-within:border-amber-200">
