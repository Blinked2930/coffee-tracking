...
export default function LeaderboardAnnouncement() {
  ...
  return (
    <div className="fixed inset-0 bg-zinc-900/60 backdrop-blur-sm z-[9999] flex items-center justify-center p-4">
      <div className="bg-white dark:bg-[#1c1c1c] rounded-[2rem] p-6 sm:p-8 w-full max-w-sm shadow-2xl animate-in zoom-in-95 duration-300 relative overflow-hidden">
        ...
        <button 
          ...
          className="absolute top-4 right-4 w-8 h-8 bg-zinc-50 hover:bg-zinc-100 dark:bg-zinc-800 dark:hover:bg-zinc-700 rounded-full flex items-center justify-center text-zinc-400 transition-colors"
        >
          <X size={16} />
        </button>
